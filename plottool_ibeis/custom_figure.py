...
def figure(fnum=None, pnum=(1, 1, 1), docla=False, title=None, figtitle=None,
    ...
    CommandLine:
        ...
        python -m plottool_ibeis.custom_figure --exec-figure:1 --show

    Example:
        >>> # ENABLE_DOCTEST
        >>> from plottool_ibeis.custom_figure import *  # NOQA
        >>> fnum = 1
...
def set_xlabel(lbl, ax=None, **kwargs):
    ...
    CommandLine:
        python -m plottool_ibeis.custom_figure set_xlabel
...
def set_figtitle(figtitle, subtitle='', forcefignum=True, incanvas=True,
    ...
    CommandLine:
        python -m plottool_ibeis.custom_figure set_figtitle --show

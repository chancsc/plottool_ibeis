...
Notes:
    ...
    cd ~/code/plottool_ibeis/docs
    sphinx-apidoc -f -o ~/code/plottool_ibeis/docs/source ~/code/plottool_ibeis/plottool_ibeis --separate
    make html
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/plottool_ibeis/advanced/
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/plottool_ibeis/versions/
"""
#
...
project = 'plottool_ibeis'
copyright = '2022, Jon Crall'
author = 'Jon Crall'
modname = 'plottool_ibeis'
...
# html_logo = '.static/plottool_ibeis.svg'
# html_favicon = '.static/plottool_ibeis.ico'
...
htmlhelp_basename = 'plottool_ibeisdoc'
...
latex_documents = [
    (master_doc, 'plottool_ibeis.tex', 'plottool_ibeis Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'plottool_ibeis', 'plottool_ibeis Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'plottool_ibeis', 'plottool_ibeis Documentation',
     author, 'plottool_ibeis', 'One line description of project.',
     'Miscellaneous'),
]
